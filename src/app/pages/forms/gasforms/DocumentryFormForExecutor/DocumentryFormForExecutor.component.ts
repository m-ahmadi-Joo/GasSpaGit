...
@Component({
  ...
  selector: "app-DocumentryFormForExecutor",
  templateUrl: "./DocumentryFormForExecutor.component.html",
  styleUrls: ["../formStyle.scss"],
})
export class  DocumentryFormForExecutorComponent implements OnInit {
  ...
  constructor(
    ...
    this.contactId= parseInt(this.route.snapshot.paramMap.get("contractId"));
        ...
        .subscribe(
          (res: any) => {
            ...
            this.router.navigate([
              "/pages/forms/ExecutorOldGasRequestEdit/" + this.gasReqId+"/contractId/"+this.contactId,
            ]);
            // }
          },
          (err) => {
