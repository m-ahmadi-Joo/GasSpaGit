...
@Component({
  selector: "ngx-AnalyzeListCustomActions",
  templateUrl: "./AnalyzeListCustomActions.component.html",
  styleUrls: ["./AnalyzeListCustomActions.component.scss"]
})
export class AnalyzeListCustomActionsComponent implements ViewCell, OnInit {
  renderValue: string;
  rData: any;
  ...
  @Output() exportAvailableEngineers: EventEmitter<any> = new EventEmitter();
  ...
  onExportAvailableEngineers() {
    this.exportAvailableEngineers.emit(this.rData.id);
  }
