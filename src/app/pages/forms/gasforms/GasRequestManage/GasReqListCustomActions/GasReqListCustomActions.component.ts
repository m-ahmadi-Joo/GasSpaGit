...
@Component({
  selector: "ngx-GasReqListCustomActions",
  templateUrl: "./GasReqListCustomActions.component.html",
  styleUrls: [
    "./GasReqListCustomActions.component.scss",
    "../../formStyle.scss",
  ],
})

export class GasReqListCustomActionsComponent implements ViewCell, OnInit {
  renderValue: string;
  rData: any;
  pdfSrc: string;
