...
@Component({
  selector: "app-gasRequestHistory",
  templateUrl: "./gasRequestHistory.component.html",
  styleUrls: ["./gasRequestHistory.component.scss"],
})
export class GasRequestHistoryComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    console.log(this.id);
    this.commandCenter.getFrom("GasRequest", "GetHistory/" + this.id).subscribe(
      (res: any) => {
