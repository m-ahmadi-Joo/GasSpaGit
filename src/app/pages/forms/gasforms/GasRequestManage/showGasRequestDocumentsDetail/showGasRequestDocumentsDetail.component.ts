...
@Component({
  selector: 'ngx-showGasRequestDocumentsDetail',
  templateUrl: './showGasRequestDocumentsDetail.component.html',
  styleUrls: ['./showGasRequestDocumentsDetail.component.scss']
})
export class ShowGasRequestDocumentsDetailComponent implements OnInit{
    base: any;
constructor(
  private commandCenter: ApiCommandCenter
) {}
@ViewChild("ShowGasRequestDocumentsDetailComponent", { static: false }) ShowGasRequestDocumentsDetailComponent: TemplateRef<any>;
