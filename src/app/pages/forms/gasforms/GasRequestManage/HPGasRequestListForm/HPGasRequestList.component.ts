...
import { HPGasReqListCustomActionsComponent } from "../HPGasReqListCustomActions/HPGasReqListCustomActions.component";
...
@Component({
  selector: "app-hPGasRequest",
  templateUrl: "./HPGasRequestList.component.html",
  styleUrls: ["../../formStyle.scss"],
})
export class HPGasRequestListComponent {
  collection = [];
    ...
    if (this.userRole.includes("Executor")) {
      this.settings.columns = {
        works: {
          ...
          renderComponent: HPGasReqListCustomActionsComponent,
