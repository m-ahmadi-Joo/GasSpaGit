...
@Component({
  ...
  templateUrl: "./EngineerEditMaplistCustomActions.component.html",
  styleUrls: ["./EngineerEditMaplistCustomActions.component.scss", "../../formStyle.scss"]
})
export class EngineerEditMapListCustomActionsComponent
  ...
  @ViewChild("RecordMapInformationHistoryEditMap", { static: false })
  RecordMapInformationHistoryEditMap: TemplateRef<any>;
  ...
  isEditMapForm:string="isEditMapForm";
  ngOnInit() {
  ...
  onHistory(requestUnitId) {
    this.windowService.open(this.RecordMapInformationHistoryEditMap, {
      hasBackdrop: true,
      windowClass: "nb-window-control"
    });
