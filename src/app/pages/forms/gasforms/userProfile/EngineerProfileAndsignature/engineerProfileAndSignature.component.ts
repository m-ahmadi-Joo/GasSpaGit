...
@Component({
  selector: "ngx-engineerProfileAndSignature",
  templateUrl: "./engineerProfileAndSignature.component.html",
  styleUrls: ["./engineerProfileAndSignature.component.scss"],
})
export class EngineerProfileAndSignatureComponent implements OnInit {
  constructor(
  ...
  ngOnInit() {
    ...
    this.api.getFrom("Engineer", "GetEngineerDetail").subscribe((res: any) => {
      this.detail = res;
    })
    ...
    this.api
      .getFrom("Engineer", "FindEngineerDocuments")
      .subscribe((res: any) => {
