...
@Component({
  selector: "app-ContractListCustomActions",
  templateUrl: "./ContractListCustomActions.component.html",
  styleUrls: [
    "./ContractListCustomActions.component.scss",
    "../formStyle.scss",
  ],
})
export class ContractListCustomActionsComponent implements ViewCell, OnInit {
  renderValue: string;
  rData: any;
