...
@Component({
  selector: 'app-recordMapInformationHistory',
  templateUrl: './RecordMapInformationHistory.component.html',
  styleUrls: ['./RecordMapInformationHistory.component.scss'],

})

export class RecordMapInformationHistoryComponent implements OnInit {
