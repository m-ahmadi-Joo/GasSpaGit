...
@Component({
  selector: "ngx-FileUploadCustomAction",
  templateUrl: "./FileUploadCustomAction.component.html",
  styleUrls: ["./FileUploadCustomAction.component.scss"]
})
export class FileUploadCustomActionComponent implements ViewCell, OnInit {
  renderValue: string;
  rData: any;
  ...
  onEdit(event) {
    this.router.navigate(["/pages/admin/CreateFileUploader/" + event.id]);
  }
}
