...
import { FileUploadCustomActionComponent } from '../..';

@Component({
  selector: "ngx-fileUploaderList",
  templateUrl: "./fileUploaderList.component.html",
  styleUrls: [
    "../../../forms/../../forms/gasforms/formStyle.scss",
    "./fileUploaderList.component.scss",
  ],
})
export class FileUploaderListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.filterParams = JSON.parse(localStorage.getItem("inspectionTariffsType"));
  ...
  settings = {
    ...
    columns: {
      works: {
        ...
        renderComponent: FileUploadCustomActionComponent,
  ...
  loadList() {
    localStorage.setItem("FileUploaderListPagination", JSON.stringify(this.filterParams));
