...
@Component({
  selector: "ngx-controlNotifyGasTariffsCustomAction",
  templateUrl: "./controlNotifyGasTariffsCustomAction.component.html",
  styleUrls: ["./controlNotifyGasTariffsCustomAction.component.scss"]
})
export class controlNotifyGasTariffsCustomActionComponent implements ViewCell, OnInit {
  renderValue: string;
  rData: any;
  ...
  onEdit(event)
  {
    this.router.navigate(["/pages/admin/CreateControlAndNotifyGasTariffsInNewBuildings/" + event.id]);
  }
}
