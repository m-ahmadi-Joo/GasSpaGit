...
import { InspectionTariffsCustomActionComponent } from '../..';

@Component({
  selector: "ngx-inspectionTariffsList",
  templateUrl: "./inspectionTariffsList.component.html",
  styleUrls: [
    "../../../forms/../../forms/gasforms/formStyle.scss",
    "./inspectionTariffsList.component.scss",
  ],
})
export class InspectionTariffsListComponent implements OnInit {
  ...
  settings = {
    ...
    columns: {
      works: {
        ...
        renderComponent: InspectionTariffsCustomActionComponent,
  ...
  loadList() {
    localStorage.setItem("inspectionTariffsType", JSON.stringify(this.filterParams));
