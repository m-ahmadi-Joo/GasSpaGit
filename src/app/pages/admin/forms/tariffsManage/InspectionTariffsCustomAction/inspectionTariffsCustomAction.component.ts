...
@Component({
  selector: "ngx-inspectionTariffsCustomAction",
  templateUrl: "./inspectionTariffsCustomAction.component.html",
  styleUrls: ["./inspectionTariffsCustomAction.component.scss"]
})
export class InspectionTariffsCustomActionComponent implements ViewCell, OnInit {
  renderValue: string;
  rData: any;
  ...
  onEdit(event)
  {
    this.router.navigate(["/pages/admin/CreateInspectionTariffs/" + event.id]);
  }
}
