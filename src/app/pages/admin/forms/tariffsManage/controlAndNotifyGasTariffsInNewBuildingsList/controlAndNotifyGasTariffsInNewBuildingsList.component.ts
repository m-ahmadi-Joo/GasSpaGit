...
import { controlNotifyGasTariffsCustomActionComponent } from '../..';

@Component({
  selector: "ngx-controlAndNotifyGasTariffsInNewBuildingsList",
  templateUrl: "./controlAndNotifyGasTariffsInNewBuildingsList.component.html",
  styleUrls: [
    "../../../forms/../../forms/gasforms/formStyle.scss",
    "./controlAndNotifyGasTariffsInNewBuildingsList.component.scss",
  ],
})
export class ControlAndNotifyGasTariffsInNewBuildingsListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.filterParams = JSON.parse(localStorage.getItem("controlAndNotifyGasTariffsInNewBuildingsList"));
  ...
  settings = {
    ...
    columns: {
      works: {
        ...
        renderComponent: controlNotifyGasTariffsCustomActionComponent,
  ...
  loadList() {
    localStorage.setItem("controlAndNotifyGasTariffsInNewBuildingsList", JSON.stringify(this.filterParams));
