...
@Component({
  selector: "ngx-CityListCustomAction",
  templateUrl: "./CityListCustomAction.component.html",
  styleUrls: ["./CityListCustomAction.component.scss"]
})
export class CityListCustomActionComponent implements ViewCell, OnInit {
  renderValue: string;
  rData: any;
