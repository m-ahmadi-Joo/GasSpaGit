...
@Component({
  selector: "ngx-townListCustomAction",
  templateUrl: "./townListCustomAction.component.html",
  styleUrls: ["./townListCustomAction.component.scss"]
})
export class TownListCustomActionComponent implements ViewCell, OnInit {
  renderValue: string;
  rData: any;
  ...
  onEdit(event)
  {
    this.router.navigate(["/pages/admin/CityTownManage/"+event.id]);
  }
}
