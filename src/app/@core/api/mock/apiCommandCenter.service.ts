...
export class ApiCommandCenterService extends ApiCommandCenter {
 ...
 //#region getAllMoreFiveUnitsList
  ...
  getScanDocumentList(
    ...
    if (filterParams != null) {
      params = params.append("fileName", filterParams.fileName);
    }
    return this.getFromByParamsAndObserveResponse(
      "Documents",
      "GetAllScanedDocuments",
      params
    ).pipe(
      map((response: any) => {
        paginatedResult.result = response.body;
  ...
  getOldGasRequestList(
    ...
    if (filterParams != null) {
      params = params.append("oldWorkStates", filterParams.oldWorkStates);
      params = params.append("oldWaitingStates", filterParams.oldWaitingStates);
      params = params.append("oldDateStart", filterParams.oldDateStart);
      params = params.append("oldDateEnd", filterParams.oldDateEnd);
      params = params.append("oldRenewerCode", filterParams.oldRenewerCode);
      params = params.append("oldOwnerName", filterParams.oldOwnerName);
      params = params.append("oldFileNumber", filterParams.oldFileNumber);
      params = params.append("oldNationalCode", filterParams.oldNationalCode);
      params = params.append("oldTowns", filterParams.oldTowns);
      params = params.append("oldAreas", filterParams.oldAreas);
      params = params.append("oldExecuterName", filterParams.oldExecuterName);
      params = params.append("requestUnitFileNumber", filterParams.requestUnitFileNumber);
    }
