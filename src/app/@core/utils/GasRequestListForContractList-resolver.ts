...
@Injectable()
export class GasRequestLisForContractResolver implements Resolve<any> {
    constructor(private api: ApiCommandCenter, private router: Router,
      private toastrService: NbToastrService) {}

      resolve(route: ActivatedRouteSnapshot): Observable<any> {
         return this.api.getFrom("GasRequest", "AllGasRequestsForUserArea")
       // return this.api.getFrom("GasRequest", "AllGasRequestsForOwnerUserArea")
          .pipe(
              catchError(error => {
